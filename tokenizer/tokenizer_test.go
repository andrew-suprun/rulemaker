...
var fixture = []struct {
	...
	{`(foo bar)`, Tokens{
		{model.Text{`(`, 0, 0}, OpenParenthesis, nil},
		{model.Text{`foo`, 0, 1}, Operation, `foo`},
		{model.Text{`bar`, 0, 5}, CanonicalField, `bar`},
		{model.Text{`)`, 0, 8}, CloseParenthesis, nil},
	}},
	...
	{` (())`, Tokens{
		{model.Text{`(`, 0, 1}, OpenParenthesis, nil},
		{model.Text{`(`, 0, 2}, OpenParenthesis, nil},
		{model.Text{`)`, 0, 3}, CloseParenthesis, nil},
		{model.Text{`)`, 0, 4}, CloseParenthesis, nil},
	}},
	...
	{`a = (foo bar);`, Tokens{
		{model.Text{`a`, 0, 0}, CanonicalField, `a`},
		{model.Text{`=`, 0, 2}, EqualSign, nil},
		{model.Text{`(`, 0, 4}, OpenParenthesis, nil},
		{model.Text{`foo`, 0, 5}, Operation, `foo`},
		{model.Text{`bar`, 0, 9}, CanonicalField, `bar`},
		{model.Text{`)`, 0, 12}, CloseParenthesis, nil},
	...
	{`a = (= bar);`, Tokens{
		...
		{model.Text{`)`, 0, 10}, CloseParenthesis, nil},
